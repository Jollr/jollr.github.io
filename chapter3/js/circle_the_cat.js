...
function Game(ctx) {
  ...
  var endSequence = function() {
    window.confirm('+1 Kat');
    $('.game').fadeOut(2000);
    $('.napoleon').fadeIn(2000);
  };

  this.winGame = function() {
    document.getElementById('panelTitle').innerHTML = 'Level up!';
    $('#panel').fadeIn(function() {});
    setTimeout(endSequence, 2000);
  };
  this.loseGame = function() {
    document.getElementById('panelTitle').innerHTML = 'Napoleon is kwijt :-(';
    $('#panel').fadeIn(function() {});
    setTimeout(run, 2000);
  };
}
